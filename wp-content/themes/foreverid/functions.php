...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Bottom Logo Menu ', 'twentysixteen' ),
		'id'            => 'bottom-logo-menu',
	...
	register_sidebar( array(
		'name'          => __( 'app store ', 'twentysixteen' ),
		'id'            => 'app-store',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Learn More Menu', 'twentysixteen' ),
		'id'            => 'learn-more-menu',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Company Menu', 'twentysixteen' ),
		'id'            => 'company-menu',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'Blog Links', 'twentysixteen' ),
		'id'            => 'text-links',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => __( 'get Links', 'twentysixteen' ),
		'id'            => 'get-links',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function crunchify_social_sharing_buttons($content) {
	...
	if(is_single()){
		...
		$content .= '<h5>SHARE </h5><a class="crunchify-link crunchify-facebook" href="'.$facebookURL.'" target="_blank"><i class="fa fa-facebook"></i></a>';
...
add_shortcode( 'the_content', 'crunchify_social_sharing_buttons');
